...
- **Change the number of clusters.** From 10 to 120 clusters, paper x patent and paper x project stay significant. project × patent never does.
- **Drop the fine-tuning.** The signal holds on base SPECTER2.
- **Comparison with the BioBrick Space**. Cities that specialize in the same research areas use similar tools. Cities close together in cluster co-occurence space are close in the biobrick co-occurence space
