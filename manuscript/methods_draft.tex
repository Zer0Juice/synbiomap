...
central empirical claim, and the analytical core of the draft: that a city's
student projects and its academic papers occupy related regions of that map ---
and, once we ask \textit{how much} of that relatedness is live coupling rather
than standing identity, that the honest answer is ``mostly standing identity.''
The third is the most ambitious, and the one we can least support: that the two
are linked in time, with projects running ahead of papers. We take them in turn,
then ask whether anything outside the text agrees.
...
than to other cities' papers. The raw advantage is small but pervasive ---
